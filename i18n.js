...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      dragToBoost: "Drag to boost — up to 600%.",
      tab: "Tab",
      language: "Language",
    ...
    vi: {
      ...
      dragToBoost: "Kéo để tăng — lên đến 600%.",
      tab: "Thẻ",
      language: "Ngôn ngữ",
    ...
    es: {
      ...
      dragToBoost: "Arrastra para amplificar — hasta el 600%.",
      tab: "Pestaña",
      language: "Idioma",
      autoLevel: "Autonivel",
    ...
    fr: {
      ...
      dragToBoost: "Glissez pour amplifier — jusqu'à 600%.",
      tab: "Onglet",
      language: "Langue",
    ...
    de: {
      ...
      dragToBoost: "Ziehen zum Verstärken — bis zu 600%.",
      tab: "Tab",
      language: "Sprache",
